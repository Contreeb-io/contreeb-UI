        ...
        <section className="max-w-[800px] flex-1 space-y-6">
          ...
          >
            ...
            <div className="space-y-2 text-sm text-[#5D5757]">
              <ul className="list-inside list-disc space-y-1">
                <li>We collect only what we need to make Contreebute work.</li>
          ...
          >
            ...
            <div className="space-y-2 text-sm text-[#5D5757]">
              ...
              <ul className="list-inside list-disc space-y-1">
                <li>“Show me everything you have on me” → we send in 48 hrs</li>
          ...
          >
            ...
            <div className="space-y-2 text-sm text-[#5D5757]">
              <ul className="list-inside list-disc space-y-1">
                ...
                <p>You can turn them off in your browser. Site still works!</p>
              </ul>
            </div>
          </article>
          <article
          ...
          >
            ...
            <div className="space-y-2 text-sm text-[#5D5757]">
              ...
              <div>
                ...
                <br />
                Thank you for trusting us with your story, your money, and your
                heart.
                <br />
