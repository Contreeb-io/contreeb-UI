        ...
        <section className="max-w-[780px] flex-1 space-y-6">
          ...
          >
            ...
            <div className="space-y-2 text-sm text-[#5D5757]">
              <p>
                ...
                <br />
                Owned and run by Contreebute Technologies, a registered Ghanaian
                company.
                <br />
          ...
          >
            ...
            <div className="space-y-2 text-sm text-[#5D5757]">
              <ul className="list-inside list-disc space-y-1.5">
                ...
                <li>
                  Copy our design or code (you can mmom but add your touch hehe)
                </li>
                <li>Spam people</li>
              ...
              <p>
                If we see this, we freeze everything and report to the police if
                needed.
              </p>
            </div>
          </article>
          <article className="space-y-2 border-b border-white pb-3" id="fees">
            ...
            <div className="space-y-2 text-sm text-[#5D5757]">
              ...
              <ul className="list-inside list-disc">
                ...
                <li>
                  Paystack charges = Almost 2% (so our actual charges are 4% for
                  personal campaigns and 2% for Public campaigns)
                </li>
              </ul>
          ...
          >
            ...
            <div className="space-y-2 text-sm text-[#5D5757]">
              <ul className="list-inside list-disc space-y-1">
                <li>
                  Campaign ends → money lands in your MoMo/Bank in 1–3 business
                  days
                </li>
          ...
          >
            ...
            <div className="space-y-2 text-sm text-[#5D5757]">
              <ul className="list-inside list-disc space-y-1">
                <li>
                  Donors can ask for a refund within 14 days if campaign breaks
                  rules
                </li>
                <li>
          ...
          >
            ...
            <div className="space-y-2 text-sm text-[#5D5757]">
              <ul className="list-inside list-disc space-y-1">
                <li>
                  We’re not responsible if your phone dies or the network fails
                  (I wanted to sub a certain network, but you all know which
                  one, hehe😅)
                </li>
          ...
          >
            ...
            <div className="space-y-2 text-sm text-[#5D5757]">
              We’ll email you or post on the site 14 days before big changes. If
              you keep using Contreebute after that, you accept the new rules.
            </div>
          </article>
          <article
            className="space-y-2 border-b border-white pb-3"
