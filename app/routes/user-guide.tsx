          ...
          <section className="max-w-[780px] flex-1 space-y-6">
            <article className="space-y-2">
              ...
              <div className="text-sm text-[#5D5757]">
                ...
                <br />
                <p className="mt-1.5">
                  Let’s walk through everything together, step by gentle step.
                  No rush. No pressure. Just soft life things…
                </p>
              </div>
            </article>
            ...
            <article className="space-y-2" id="what-is-contreebute">
              ...
              <div className="space-y-1.5 text-sm text-[#5D5757]">
                <p>
                  {" "}
                  Family, friends and strangers already help each other every
                  day. It's just done the hard way. <br /> Contreebute removes
                  the shame of begging, getting ignored, delays in gifting and
                  high fees. This makes the same people who already want to help
                  you… actually do!
                </p>
                ...
                <p>
                  ...
                  watch your dreams become a reality in your MoMo or bank
                  account.
                </p>
                <p>
            ...
            <article className="space-y-4" id="two-types-of-campaigns">
              ...
              <p className="text-sm">
                ...
                shouldn’t cost more than a birthday gift. <br /> We lower fees
                for causes so more love reaches those who need it most.
              </p>
            </article>
                  ...
                  <li>
                    ...
                    <ul className="mt-0.5 ml-5 list-inside list-disc space-y-0.5">
                      <li>
                        ...
                        (MTN, Vodafone, AT) —&gt; What we recommend (fastest)
                      </li>
                      <li>
            ...
            <article className="space-y-4" id="when-how-paid">
              ...
              <div className="space-y-1.5 text-sm text-[#5D5757]">
                <p>
                  Here’s exactly what happens the moment your campaign ends:
                </p>
                <ul className="list-inside list-decimal space-y-1.5">
                  ...
                  <li>
                    ...
                    <p className="pl-1.5 md:pl-4">
                      Only the small fee we already showed you. No hidden
                      charges!
                    </p>
                  </li>
                  <li>
                    ...
                    <p className="pl-1.5 md:pl-4">
                      ...
                      safely within 1–3 business days. You’ll see the
                      notification from Contreebute Technologies (that’s our
            ...
            <article className="space-y-4" id="your-dashboard">
              ...
              <div className="space-y-1.5 text-sm text-[#5D5757]">
                ...
                <div>
                  ...
                  <p className="mt-1.5">
                    <span className="font-bold">Actions:</span> Export list,
                    send thank-you, share update
                  </p>
                </div>
              </div>
            </article>
              ...
              <div className="space-y-2 text-sm text-[#5D5757]">
                <ul className="list-inside list-disc">
                  ...
                  <li>
                    ...
                    <a href="mailto:hello@contreebute.io">
              ...
              <div className="space-y-2 text-sm text-[#5D5757]">
                <div className="space-y-1">
                  <h5 className="font-bold">
                    Q: Do I pay to start a campaign?
                  </h5>
                  <p>
                    <span className="font-bold">A:</span> Never. It’s 100% free
                ...
                <div className="space-y-1">
                  ...
                  <p>
                    <span className="font-bold">A:</span> Only after your
                    campaign ends — and only if you raise money.
                  </p>
                </div>
                <div className="space-y-1">
                  <h5 className="font-bold">
